...
- **Rediseño e incorporación de 5 diagramas SVG pedagógicos:**
...
- **Publicación web:** Se creó `docs/semana-02/index.html` garantizando paridad total con `Entregables/Semana 02/Guía de estudio - Semana 02.html` (con rutas de marca relativas adaptadas a `../assets/brand/`).
